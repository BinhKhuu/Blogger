...
require_once 'lib/list-post.php';
...
if ($_POST)
{
    ...
    if ($deleteResponse)
    {
        /* when deleted is submitted it will store an ID value in the first location
         * via name="delete-post[<?php echo $post['id']?>]"
         */
